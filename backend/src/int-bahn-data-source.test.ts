...
describe("int.bahn.de transit data source", () => {
  it("maps departure entries from the DB stop-times analogue", async () => {
    ...
    expect(result.stopTimes[0]).toMatchObject({ tripId: "db-trip-1", displayName: "RE 1", mode: "REGIONAL_RAIL", realTime: true, place: { scheduledDeparture: "2026-08-11T17:00:00+02:00" }, tripTo: { name: "Düsseldorf Hbf", scheduledArrival: "2026-08-11T19:00:00+02:00" } });
  });
