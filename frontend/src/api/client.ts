...
export type AdminDashboard = {
  ...
  entries: Array<{
    ...
    position: number | null; cancelled: boolean; stale: boolean; raceColor: string | null; betCount: number; delayHistory: Array<{ delayMinutes: number; recordedAt: string }>;
  }>;
